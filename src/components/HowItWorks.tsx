        ...
        <div className="grid grid-cols-4 gap-8 relative z-10">
          {steps.map((step, i) => (
            <div key={step.number}>
              {/* Circle */}
              <motion.div
                className="relative z-10 w-10 h-10 md:w-12 md:h-12 rounded-full bg-accent-light border-2 border-accent flex items-center justify-center mx-auto md:mx-0"
